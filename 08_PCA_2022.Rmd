...
ggplot(data = eigenVectors_noCent) +
  ...
  theme(
    ...
    axis.text = element_text(color = "black", size = 20),
    legend.spacing.y = unit(0.03, "cm"))
ggsave(filename = "plink_PC1PC2_PlinkFiltering_noCent_topo_fill_labels.png", path = "/mnt/scratch/buysseso/PCA", height = 7, width = 7, device = "png", dpi = 500)
...
ggsave(filename = "plink_het_PlinkFiltering_labels.png", path = "/mnt/scratch/buysseso/PCA", height = 7, width = 9, dpi = 500)
# old plot
ggplot(data = het_dat)+
...
ggplot(data = het_dat)+
  ...
  theme(
    ...
    axis.text = element_text(color = "black", size = 20),
    legend.spacing.y = unit(0.03, "cm")) # was 0.001
ggsave(filename = "plink_het_PlinkFiltering_noCent_labels.png", path = "/mnt/scratch/buysseso/PCA", height = 7, width = 9, dpi = 500)
