...
# Reminder! Tube is equivalent to the time point, so 1 is the first 10 ish flowers, 2 is from around the 20th flower produced, and 3 is around the 30th flower produced and that is why there are multiples form tube b/c multiple flowers collected at each time point
...
min(PerLine$NumFlwr)
# 1 -- this is worrying to me... only 1 flower for 1 plant for this line?
...
```{r}
Seq <- read.csv("C:/Users/Sophie/Michigan State University/Conner, Jeffrey - SophieAnalyses/SpanishMasterDataset_Sequenced.csv")
# Reminder! Tube is equivalent to the time point, so 1 is the first 10 ish flowers, 2 is from around the 20th flower produced, and 3 is around the 30th flower produced and that is why there are multiples form tube b/c multiple flowers collected at each time point
...
# Questions
Should I drop the two lines that only have one flower phenotyped? They are both sequenced.
