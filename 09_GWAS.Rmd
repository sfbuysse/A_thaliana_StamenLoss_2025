...
top_hits <- read.csv("C:/Users/Sophia/Michigan State University/Conner, Jeffrey - SophieAnalyses/GemmaOutput_2022/Top_hits_wald_Jan2023.csv")

# waht my dataframe should look like is column 1 of snp locations
...
for (i in c(1:length(hits_chr1))){
  tmp_list <- c(hits_chr1$min[i]:hits_chr1$max[i])
  for (j in c(1:length(hits_chr1))){
...
# for this loop, each output is a 1x15 dataframe so that means there is no overlap in hits if I only look at 100 bp 

# what about 500 just for fun quick? still the same result

# what I might wnat to do is figure out the LD decay in my sample and use that?

# but these loops work and I think they do want I want, but maybe I should makea same datafame to make sure before I just go with it as working.
