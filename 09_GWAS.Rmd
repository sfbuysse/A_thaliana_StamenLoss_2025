...
id_snps <- function(input){
  ...
  for (i in c(1:len)){
    ...
    # if statement to only keep output dataframes with more than one SNP - I think this is causing problems currently, Maybe I can just remove it b/c the multiple types of GWAS code will bring down my sample size?
