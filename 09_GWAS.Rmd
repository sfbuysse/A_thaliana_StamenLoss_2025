...
I stopped working in the chunk above this note on 5/16/2023

The above code does what I want it to do for chromosome 1, but it would be nice to not need to copy and paste ALL of that code for each chromosome. However, I think it might be too complicated to make into a single function. I could probably make my loop that makes the long list into a function.
