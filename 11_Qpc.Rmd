...
# these are not in the same order... and the pheno id doesn't fully match the pheno id... 
...
# ugh make it a dataframe to merge - so I guess I could have kept this in the prep file.
